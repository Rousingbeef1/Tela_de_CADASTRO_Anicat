...
export default function Corpo() {
    ...
    return (
        <div className=" flex w-auto h-screen justify-center items-center bg-[url(/assets/background/fundo2.jpg)] bg-right bg-no-repeat bg-cover flex-col">
            <div className="bg-[#212121] flex-col justify-start items-start flex w-[500px] h-auto p-10 gap-10 font-[32px]" >

                <TextField inputProps={{ style: { color: "white" } }} InputLabelProps={{ style: { color: "white", fontSize: '20px' } }} className='w-full ' variant="standard" label="Endereço de E-mail" color="warning" />
            ...
            <label className="w-[500px] font-[13px] text-center mt-5">Ao criar esta conta, você declara estar de acordo com nossos Termos e Política de privacidade, e declara possuir 16 anos de idade ou mais.</label>
            <button className="px-[172px] bg-[#F9C718] text-[30px] rounded-lg mt-4">Criar conta</button>
        </div>
    )
}